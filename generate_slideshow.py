...
def generate_html(chapters):
    ...
    <div class="slide slide-content" data-index="{i}">
      <div class="content-card">
        ...
        <ul class="content-list">
          <li><strong>Nutrition & development</strong> — Chronic malnutrition and limited access to quality education have measurable effects on cognitive development, particularly in rural areas.</li>
          <li><strong>Food culture</strong> — Meals are built around starches (fufu, banku, rice) with stews. The emphasis is on caloric sustenance over variety. Western-style restaurants are rare outside Accra.</li>
          <li><strong>Service & tourism</strong> — There is no established hospitality culture. Tourist-facing services can feel improvised, and accommodation prices often approach European levels without matching the quality.</li>
          <li><strong>Infrastructure</strong> — Roads deteriorate quickly outside cities. Power outages ("dumsor") and unreliable water supply are everyday realities.</li>
          <li><strong>Corruption</strong> — Pervasive and systemic: from roadside police stops to government procurement. Widely acknowledged by Ghanaians themselves.</li>
          <li><strong>Democracy</strong> — A genuine bright spot. Ghana has had peaceful transfers of power since 1992, a free press, and an engaged electorate. The 2024 election saw a smooth opposition victory.</li>
        </ul>
        </div>
        <div class="lang-de">
        <h2>Leben in Ghana</h2>
        <ul class="content-list">
          <li><strong>Ernährung & Entwicklung</strong> — Chronische Unterernährung und eingeschränkter Zugang zu guter Bildung wirken sich messbar auf die kognitive Entwicklung aus, besonders in ländlichen Gebieten.</li>
          <li><strong>Esskultur</strong> — Mahlzeiten basieren auf Stärkebeilagen (Fufu, Banku, Reis) mit Eintöpfen. Der Fokus liegt auf Sättigung, nicht auf Vielfalt. Restaurants westlichen Stils sind außerhalb Accras selten.</li>
          <li><strong>Service & Tourismus</strong> — Es gibt keine gewachsene Gastgeberkultur. Touristische Angebote wirken oft improvisiert, und die Unterkunftspreise erreichen europäisches Niveau, ohne die Qualität zu bieten.</li>
          <li><strong>Infrastruktur</strong> — Straßen verschlechtern sich schnell außerhalb der Städte. Stromausfälle („Dumsor") und unzuverlässige Wasserversorgung gehören zum Alltag.</li>
          <li><strong>Korruption</strong> — Allgegenwärtig und systemisch: von Polizeikontrollen am Straßenrand bis zur Auftragsvergabe der Regierung. Wird von den Ghanaern selbst offen eingeräumt.</li>
          <li><strong>Demokratie</strong> — Ein echter Lichtblick. Ghana hat seit 1992 friedliche Machtwechsel erlebt, eine freie Presse und eine engagierte Wählerschaft. Die Wahl 2024 brachte einen reibungslosen Oppositionssieg.</li>
        </ul>
        </div>
      </div>
    </div>''')
    ...
    <div class="slide slide-content" data-index="{i}">
      <div class="content-card">
        ...
        <ul class="content-list">
          <li><strong>Scale</strong> — An estimated 12.5 million Africans were shipped across the Atlantic over roughly 400 years. Millions more died in capture and transit.</li>
          <li><strong>Elmina Castle</strong> — Built by the Portuguese in 1482, it is the oldest European structure in sub-Saharan Africa. Later seized by the Dutch and used as a major slave-trading hub.</li>
          <li><strong>Cape Coast Castle</strong> — The British headquarters of the Gold Coast slave trade. Its underground dungeons held up to 1,000 captives at a time in total darkness.</li>
          <li><strong>The garrisons</strong> — Remarkably small European garrisons — often fewer than 100 men — controlled these massive operations, relying heavily on local intermediaries.</li>
          <li><strong>African collaboration</strong> — Powerful states like the Ashanti Empire and Fante chiefs actively supplied war captives and kidnapped people to European traders. The trade reshaped regional power dynamics.</li>
          <li><strong>Legacy</strong> — Centuries of depopulation, broken family and social structures, and economic extraction left lasting damage across West Africa that continues to shape the region today.</li>
        </ul>
        </div>
        <div class="lang-de">
        <h2>Die Sklavenfestungen</h2>
        <ul class="content-list">
          <li><strong>Ausmaß</strong> — Schätzungsweise 12,5 Millionen Afrikaner wurden über rund 400 Jahre über den Atlantik verschleppt. Millionen weitere starben bei Gefangennahme und Transport.</li>
          <li><strong>Elmina Castle</strong> — 1482 von den Portugiesen erbaut, ist es das älteste europäische Bauwerk in Subsahara-Afrika. Später von den Niederländern übernommen und als bedeutendes Zentrum des Sklavenhandels genutzt.</li>
          <li><strong>Cape Coast Castle</strong> — Das britische Hauptquartier des Sklavenhandels an der Goldküste. In seinen unterirdischen Kerkern wurden bis zu 1.000 Gefangene gleichzeitig in völliger Dunkelheit festgehalten.</li>
          <li><strong>Die Garnisonen</strong> — Bemerkenswert kleine europäische Garnisonen — oft weniger als 100 Mann — kontrollierten diese massiven Operationen und stützten sich stark auf einheimische Mittelsmänner.</li>
          <li><strong>Afrikanische Beteiligung</strong> — Mächtige Staaten wie das Ashanti-Reich und Fante-Häuptlinge lieferten aktiv Kriegsgefangene und entführte Menschen an europäische Händler. Der Handel veränderte die regionalen Machtverhältnisse grundlegend.</li>
          <li><strong>Vermächtnis</strong> — Jahrhunderte der Entvölkerung, zerstörte Familien- und Sozialstrukturen sowie wirtschaftliche Ausbeutung hinterließen bleibende Schäden in Westafrika, die die Region bis heute prägen.</li>
        </ul>
        </div>
      </div>
    </div>''')
    ...
    <div class="slide slide-content" data-index="{i}">
      <div class="content-card">
        ...
        <ul class="content-list">
          <li><strong>The model</strong> — "Voluntourism" is big business: participants pay NGOs or agencies for a placement, covering their own costs plus a fee. The NGO places them in schools, orphanages, or community projects.</li>
          <li><strong>Questionable impact</strong> — Many placements provide unskilled labour that displaces local workers. Short stays (1–4 weeks) rarely produce lasting benefit. Some orphanages have been found to recruit children specifically to attract volunteers and donations.</li>
          <li><strong>The case for meritocracy</strong> — The most powerful long-term contribution may not be hands-on work, but demonstrating meritocratic principles: the idea that effort, talent, and integrity should determine outcomes — not family connections, bribes, or tribal affiliations.</li>
          <li><strong>Structural dependency</strong> — A steady flow of well-meaning foreigners can inadvertently reinforce dependency rather than building local capacity. The best programmes focus on training local people to lead.</li>
        </ul>
        </div>
        <div class="lang-de">
        <h2>Freiwilligenarbeit in Ghana</h2>
        <ul class="content-list">
          <li><strong>Das Modell</strong> — „Voluntourismus" ist ein großes Geschäft: Teilnehmer zahlen NGOs oder Agenturen für einen Einsatzplatz und tragen ihre eigenen Kosten plus eine Gebühr. Die NGO vermittelt sie an Schulen, Waisenhäuser oder Gemeindeprojekte.</li>
          <li><strong>Fraglicher Nutzen</strong> — Viele Einsätze bieten ungelernte Arbeit, die lokale Arbeitskräfte verdrängt. Kurze Aufenthalte (1–4 Wochen) bringen selten nachhaltigen Nutzen. Manche Waisenhäuser werben gezielt Kinder an, um Freiwillige und Spenden anzuziehen.</li>
          <li><strong>Leistungsprinzip</strong> — Der wirkungsvollste langfristige Beitrag ist möglicherweise nicht die praktische Arbeit, sondern das Vorleben meritokratischer Prinzipien: dass Leistung, Talent und Integrität über Ergebnisse entscheiden sollten — nicht Beziehungen, Bestechung oder Stammeszugehörigkeit.</li>
          <li><strong>Strukturelle Abhängigkeit</strong> — Ein stetiger Strom gutmeinender Ausländer kann unbeabsichtigt Abhängigkeit verstärken, statt lokale Kapazitäten aufzubauen. Die besten Programme setzen darauf, Einheimische zu Führungskräften auszubilden.</li>
        </ul>
        </div>
      </div>
    </div>''')
